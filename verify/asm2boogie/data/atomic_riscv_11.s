...
vatomic32_write_rel:
	fence iorw,ow; amoswap.w zero,a1,0(a0)
	ret
...
vatomic64_write_rel:
	fence iorw,ow; amoswap.d zero,a1,0(a0)
	ret
...
vatomic32_xchg_rel:
	fence iorw,ow; amoswap.w a1,a1,0(a0)
	sext.w	a0,a1
	ret
...
vatomic64_xchg_rel:
	fence iorw,ow; amoswap.d a1,a1,0(a0)
	mv	a0,a1
	ret
...
vatomic32_cmpxchg:
	fence iorw,ow;  1: lr.w.aq a5,0(a0); bne a5,a1,1f; sc.w.aq a4,a2,0(a0); bnez a4,1b; 1:
	sext.w	a0,a5
	ret
...
vatomic32_cmpxchg_acq:
	 1: lr.w.aq a5,0(a0); bne a5,a1,1f; sc.w.aq a4,a2,0(a0); bnez a4,1b; 1:
	sext.w	a0,a5
	ret
...
vatomic32_cmpxchg_rel:
	 1: lr.w a5,0(a0); bne a5,a1,1f; sc.w a4,a2,0(a0); bnez a4,1b; 1:
	sext.w	a0,a5
	ret
...
vatomic64_cmpxchg:
	mv	a5,a0
	fence iorw,ow;  1: lr.d.aq a0,0(a5); bne a0,a1,1f; sc.d.aq a4,a2,0(a5); bnez a4,1b; 1:
	ret
...
vatomic64_cmpxchg_acq:
	mv	a5,a0
	 1: lr.d.aq a0,0(a5); bne a0,a1,1f; sc.d.aq a4,a2,0(a5); bnez a4,1b; 1:
	ret
...
vatomic64_cmpxchg_rel:
	mv	a5,a0
	 1: lr.d a0,0(a5); bne a0,a1,1f; sc.d a4,a2,0(a5); bnez a4,1b; 1:
	ret
...
vatomic32_get_and_rel:
	fence iorw,ow; amoand.w a5,a1,0(a0)
	sext.w	a0,a5
	ret
...
vatomic64_get_and_rel:
	mv	a5,a0
	fence iorw,ow; amoand.d a0,a1,0(a5)
	ret
...
vatomic32_get_or_rel:
	fence iorw,ow; amoor.w a5,a1,0(a0)
	sext.w	a0,a5
	ret
...
vatomic64_get_or_rel:
	mv	a5,a0
	fence iorw,ow; amoor.d a0,a1,0(a5)
	ret
...
vatomic32_get_xor_rel:
	fence iorw,ow; amoxor.w a5,a1,0(a0)
	sext.w	a0,a5
	ret
...
vatomic64_get_xor_rel:
	mv	a5,a0
	fence iorw,ow; amoxor.d a0,a1,0(a5)
	ret
...
vatomic32_get_add_rel:
	fence iorw,ow; amoadd.w a5,a1,0(a0)
	sext.w	a0,a5
	ret
...
vatomic64_get_add_rel:
	mv	a5,a0
	fence iorw,ow; amoadd.d a0,a1,0(a5)
	ret
...
vatomic32_get_max:
	...
	bgeu	a0,a1,.L333
.L336:
	fence iorw,ow;  1: lr.w.aq a5,0(a4); bne a5,a0,1f; sc.w.aq a3,a1,0(a4); bnez a3,1b; 1:
	sext.w	a5,a5
	beq	a0,a5,.L333
	mv	a0,a5
	bltu	a0,a1,.L336
...
vatomic32_get_max_acq:
	...
	bgeu	a0,a1,.L338
.L341:
	 1: lr.w.aq a5,0(a4); bne a5,a0,1f; sc.w.aq a3,a1,0(a4); bnez a3,1b; 1:
	sext.w	a5,a5
	beq	a0,a5,.L338
	mv	a0,a5
	bltu	a0,a1,.L341
...
vatomic32_get_max_rel:
	...
	bgeu	a0,a1,.L343
.L346:
	 1: lr.w a5,0(a4); bne a5,a0,1f; sc.w a3,a1,0(a4); bnez a3,1b; 1:
	sext.w	a5,a5
	beq	a0,a5,.L343
	mv	a0,a5
	bltu	a0,a1,.L346
...
vatomic64_get_max:
	...
	bgeu	a0,a1,.L352
.L356:
	fence iorw,ow;  1: lr.d.aq a5,0(a4); bne a5,a0,1f; sc.d.aq a3,a1,0(a4); bnez a3,1b; 1:
	beq	a0,a5,.L352
	mv	a0,a5
	bltu	a0,a1,.L356
.L352:
...
vatomic64_get_max_acq:
	...
	bgeu	a0,a1,.L357
.L361:
	 1: lr.d.aq a5,0(a4); bne a5,a0,1f; sc.d.aq a3,a1,0(a4); bnez a3,1b; 1:
	beq	a0,a5,.L357
	mv	a0,a5
	bltu	a0,a1,.L361
.L357:
...
vatomic64_get_max_rel:
	...
	bgeu	a0,a1,.L362
.L366:
	 1: lr.d a5,0(a4); bne a5,a0,1f; sc.d a3,a1,0(a4); bnez a3,1b; 1:
	beq	a0,a5,.L362
	mv	a0,a5
	bltu	a0,a1,.L366
.L362:
...
vatomic32_max_get:
	...
	bleu	a1,a4,.L465
.L469:
	fence iorw,ow;  1: lr.w.aq a5,0(a0); bne a5,a4,1f; sc.w.aq a3,a1,0(a0); bnez a3,1b; 1:
	sext.w	a5,a5
	beq	a4,a5,.L465
	mv	a4,a5
	bgtu	a1,a4,.L469
...
vatomic32_max_get_acq:
	...
	bleu	a1,a4,.L471
.L475:
	 1: lr.w.aq a5,0(a0); bne a5,a4,1f; sc.w.aq a3,a1,0(a0); bnez a3,1b; 1:
	sext.w	a5,a5
	beq	a4,a5,.L471
	mv	a4,a5
	bgtu	a1,a4,.L475
...
vatomic32_max_get_rel:
	...
	bleu	a1,a4,.L477
.L481:
	 1: lr.w a5,0(a0); bne a5,a4,1f; sc.w a3,a1,0(a0); bnez a3,1b; 1:
	sext.w	a5,a5
	beq	a4,a5,.L477
	mv	a4,a5
	bgtu	a1,a4,.L481
...
vatomic64_max_get:
	...
	bleu	a1,a5,.L489
.L493:
	fence iorw,ow;  1: lr.d.aq a4,0(a0); bne a4,a5,1f; sc.d.aq a3,a1,0(a0); bnez a3,1b; 1:
	beq	a5,a4,.L489
	mv	a5,a4
	bgtu	a1,a5,.L493
.L489:
...
vatomic64_max_get_acq:
	...
	bleu	a1,a5,.L495
.L499:
	 1: lr.d.aq a4,0(a0); bne a4,a5,1f; sc.d.aq a3,a1,0(a0); bnez a3,1b; 1:
	beq	a5,a4,.L495
	mv	a5,a4
	bgtu	a1,a5,.L499
.L495:
...
vatomic64_max_get_rel:
	...
	bleu	a1,a5,.L501
.L505:
	 1: lr.d a4,0(a0); bne a4,a5,1f; sc.d a3,a1,0(a0); bnez a3,1b; 1:
	beq	a5,a4,.L501
	mv	a5,a4
	bgtu	a1,a5,.L505
.L501:
...
vatomic32_and:
	fence iorw,ow; amoand.w.aq zero,a1,0(a0)
	ret
	.size	vatomic32_and, .-vatomic32_and
	.align	1
	.type	vatomic32_and_rel, @function
vatomic32_and_rel:
	fence iorw,ow; amoand.w zero,a1,0(a0)
	ret
...
vatomic64_and:
	fence iorw,ow; amoand.d.aq zero,a1,0(a0)
	ret
	.size	vatomic64_and, .-vatomic64_and
	.align	1
	.type	vatomic64_and_rel, @function
vatomic64_and_rel:
	fence iorw,ow; amoand.d zero,a1,0(a0)
	ret
...
vatomic32_or:
	fence iorw,ow; amoor.w.aq zero,a1,0(a0)
	ret
	.size	vatomic32_or, .-vatomic32_or
	.align	1
	.type	vatomic32_or_rel, @function
vatomic32_or_rel:
	fence iorw,ow; amoor.w zero,a1,0(a0)
	ret
...
vatomic64_or:
	fence iorw,ow; amoor.d.aq zero,a1,0(a0)
	ret
	.size	vatomic64_or, .-vatomic64_or
	.align	1
	.type	vatomic64_or_rel, @function
vatomic64_or_rel:
	fence iorw,ow; amoor.d zero,a1,0(a0)
	ret
...
vatomic32_xor:
	fence iorw,ow; amoxor.w.aq zero,a1,0(a0)
	ret
	.size	vatomic32_xor, .-vatomic32_xor
	.align	1
	.type	vatomic32_xor_rel, @function
vatomic32_xor_rel:
	fence iorw,ow; amoxor.w zero,a1,0(a0)
	ret
...
vatomic64_xor:
	fence iorw,ow; amoxor.d.aq zero,a1,0(a0)
	ret
	.size	vatomic64_xor, .-vatomic64_xor
	.align	1
	.type	vatomic64_xor_rel, @function
vatomic64_xor_rel:
	fence iorw,ow; amoxor.d zero,a1,0(a0)
	ret
...
vatomic32_add_get_rel:
	mv	a5,a0
	fence iorw,ow; amoadd.w a0,a1,0(a5)
	addw	a0,a0,a1
	ret
...
vatomic32_add_rel:
	fence iorw,ow; amoadd.w zero,a1,0(a0)
	ret
...
vatomic64_add:
	fence iorw,ow; amoadd.d.aq zero,a1,0(a0)
	ret
	.size	vatomic64_add, .-vatomic64_add
	.align	1
	.type	vatomic64_add_rel, @function
vatomic64_add_rel:
	fence iorw,ow; amoadd.d zero,a1,0(a0)
	ret
...
vatomic32_get_inc:
	li	a4,1
	fence iorw,ow; amoadd.w.aq a5,a4,0(a0)
	sext.w	a0,a5
	ret
...
vatomic32_get_inc_rel:
	li	a4,1
	fence iorw,ow; amoadd.w a5,a4,0(a0)
	sext.w	a0,a5
	ret
...
vatomic64_get_inc:
	mv	a5,a0
	li	a4,1
	fence iorw,ow; amoadd.d.aq a0,a4,0(a5)
	ret
...
vatomic64_get_inc_rel:
	mv	a5,a0
	li	a4,1
	fence iorw,ow; amoadd.d a0,a4,0(a5)
	ret
...
vatomic64_inc_get:
	li	a4,1
	fence iorw,ow; amoadd.d.aq a5,a4,0(a0)
	addi	a0,a5,1
	ret
...
vatomic64_inc_get_rel:
	li	a4,1
	fence iorw,ow; amoadd.d a5,a4,0(a0)
	addi	a0,a5,1
	ret
...
vatomic32_inc:
	li	a5,1
	fence iorw,ow; amoadd.w.aq zero,a5,0(a0)
	ret
...
vatomic32_inc_rel:
	li	a5,1
	fence iorw,ow; amoadd.w zero,a5,0(a0)
	ret
...
vatomic64_inc:
	li	a5,1
	fence iorw,ow; amoadd.d.aq zero,a5,0(a0)
	ret
...
vatomic64_inc_rel:
	li	a5,1
	fence iorw,ow; amoadd.d zero,a5,0(a0)
	ret
...
vatomic32_sub_get:
	mv	a5,a0
	negw	a4,a1
	fence iorw,ow; amoadd.w.aq a0,a4,0(a5)
	subw	a0,a0,a1
	ret
...
vatomic32_sub_get_rel:
	mv	a5,a0
	negw	a4,a1
	fence iorw,ow; amoadd.w a0,a4,0(a5)
	subw	a0,a0,a1
	ret
...
.L1326:
	addw	a2,a0,a1
	fence iorw,ow;  1: lr.w.aq a5,0(a4); bne a5,a0,1f; sc.w.aq a6,a2,0(a4); bnez a6,1b; 1:
	sext.w	a5,a5
	bne	a0,a5,.L1329
	ret
...
.L1336:
	addw	a2,a0,a1
	 1: lr.w.aq a5,0(a4); bne a5,a0,1f; sc.w.aq a6,a2,0(a4); bnez a6,1b; 1:
	sext.w	a5,a5
	bne	a0,a5,.L1339
	ret
...
.L1346:
	addw	a2,a0,a1
	 1: lr.w a5,0(a4); bne a5,a0,1f; sc.w a6,a2,0(a4); bnez a6,1b; 1:
	sext.w	a5,a5
	bne	a0,a5,.L1349
	ret
...
.L1414:
	mv	a0,a5
.L1406:
	fence iorw,ow;  1: lr.w.aq a5,0(a4); bne a5,a0,1f; sc.w.aq a1,a2,0(a4); bnez a1,1b; 1:
	sext.w	a5,a5
	bne	a0,a5,.L1409
	ret
...
.L1424:
	mv	a0,a5
.L1416:
	 1: lr.w.aq a5,0(a4); bne a5,a0,1f; sc.w.aq a1,a2,0(a4); bnez a1,1b; 1:
	sext.w	a5,a5
	bne	a0,a5,.L1419
	ret
...
.L1434:
	mv	a0,a5
.L1426:
	 1: lr.w a5,0(a4); bne a5,a0,1f; sc.w a1,a2,0(a4); bnez a1,1b; 1:
	sext.w	a5,a5
	bne	a0,a5,.L1429
	ret
...
.L1806:
	add	a2,a0,a1
	fence iorw,ow;  1: lr.d.aq a5,0(a4); bne a5,a0,1f; sc.d.aq a6,a2,0(a4); bnez a6,1b; 1:
	bne	a0,a5,.L1809
	ret
...
.L1816:
	add	a2,a0,a1
	 1: lr.d.aq a5,0(a4); bne a5,a0,1f; sc.d.aq a6,a2,0(a4); bnez a6,1b; 1:
	bne	a0,a5,.L1819
	ret
...
.L1826:
	add	a2,a0,a1
	 1: lr.d a5,0(a4); bne a5,a0,1f; sc.d a6,a2,0(a4); bnez a6,1b; 1:
	bne	a0,a5,.L1829
	ret
...
.L1894:
	mv	a0,a5
.L1886:
	fence iorw,ow;  1: lr.d.aq a5,0(a4); bne a5,a0,1f; sc.d.aq a1,a2,0(a4); bnez a1,1b; 1:
	bne	a0,a5,.L1889
	ret
...
.L1904:
	mv	a0,a5
.L1896:
	 1: lr.d.aq a5,0(a4); bne a5,a0,1f; sc.d.aq a1,a2,0(a4); bnez a1,1b; 1:
	bne	a0,a5,.L1899
	ret
...
.L1914:
	mv	a0,a5
.L1906:
	 1: lr.d a5,0(a4); bne a5,a0,1f; sc.d a1,a2,0(a4); bnez a1,1b; 1:
	bne	a0,a5,.L1909
	ret
...
.L2286:
	...
	beq	a1,a5,.L2286
	addw	a3,a2,a5
	fence iorw,ow;  1: lr.w.aq a0,0(a4); bne a0,a5,1f; sc.w.aq a6,a3,0(a4); bnez a6,1b; 1:
	sext.w	a0,a0
	bne	a0,a5,.L2286
	ret
...
.L2291:
	...
	beq	a1,a5,.L2291
	addw	a3,a2,a5
	 1: lr.w.aq a0,0(a4); bne a0,a5,1f; sc.w.aq a6,a3,0(a4); bnez a6,1b; 1:
	sext.w	a0,a0
	bne	a0,a5,.L2291
	ret
...
.L2296:
	...
	beq	a1,a5,.L2296
	addw	a3,a2,a5
	 1: lr.w a0,0(a4); bne a0,a5,1f; sc.w a6,a3,0(a4); bnez a6,1b; 1:
	sext.w	a0,a0
	bne	a0,a5,.L2296
	ret
...
.L2326:
	...
	sext.w	a5,a5
	beq	a1,a5,.L2326
	fence iorw,ow;  1: lr.w.aq a0,0(a4); bne a0,a5,1f; sc.w.aq a3,a2,0(a4); bnez a3,1b; 1:
	sext.w	a0,a0
	bne	a0,a5,.L2326
	ret
...
.L2331:
	...
	sext.w	a5,a5
	beq	a1,a5,.L2331
	 1: lr.w.aq a0,0(a4); bne a0,a5,1f; sc.w.aq a3,a2,0(a4); bnez a3,1b; 1:
	sext.w	a0,a0
	bne	a0,a5,.L2331
	ret
...
.L2336:
	...
	sext.w	a5,a5
	beq	a1,a5,.L2336
	 1: lr.w a0,0(a4); bne a0,a5,1f; sc.w a3,a2,0(a4); bnez a3,1b; 1:
	sext.w	a0,a0
	bne	a0,a5,.L2336
	ret
...
.L2346:
	...
	beq	a1,a5,.L2346
	add	a3,a2,a5
	fence iorw,ow;  1: lr.d.aq a0,0(a4); bne a0,a5,1f; sc.d.aq a6,a3,0(a4); bnez a6,1b; 1:
	bne	a0,a5,.L2346
	ret
...
.L2351:
	...
	beq	a1,a5,.L2351
	add	a3,a2,a5
	 1: lr.d.aq a0,0(a4); bne a0,a5,1f; sc.d.aq a6,a3,0(a4); bnez a6,1b; 1:
	bne	a0,a5,.L2351
	ret
...
.L2356:
	...
	beq	a1,a5,.L2356
	add	a3,a2,a5
	 1: lr.d a0,0(a4); bne a0,a5,1f; sc.d a6,a3,0(a4); bnez a6,1b; 1:
	bne	a0,a5,.L2356
	ret
...
.L2386:
	...
	fence	iorw,iorw
	beq	a1,a5,.L2386
	fence iorw,ow;  1: lr.d.aq a0,0(a4); bne a0,a5,1f; sc.d.aq a3,a2,0(a4); bnez a3,1b; 1:
	bne	a0,a5,.L2386
	ret
...
.L2391:
	ld	a5,0(a4)
	beq	a1,a5,.L2391
	 1: lr.d.aq a0,0(a4); bne a0,a5,1f; sc.d.aq a3,a2,0(a4); bnez a3,1b; 1:
	bne	a0,a5,.L2391
	ret
...
.L2396:
	ld	a5,0(a4)
	beq	a1,a5,.L2396
	 1: lr.d a0,0(a4); bne a0,a5,1f; sc.d a3,a2,0(a4); bnez a3,1b; 1:
	bne	a0,a5,.L2396
	ret
...
.L2406:
	...
	fence	iorw,iorw
	beq	a1,a0,.L2406
	fence iorw,ow;  1: lr.d.aq a4,0(a5); bne a4,a0,1f; sc.d.aq a3,a2,0(a5); bnez a3,1b; 1:
	bne	a0,a4,.L2406
	ret
...
.L2411:
	ld	a0,0(a5)
	beq	a1,a0,.L2411
	 1: lr.d.aq a4,0(a5); bne a4,a0,1f; sc.d.aq a3,a2,0(a5); bnez a3,1b; 1:
	bne	a0,a4,.L2411
	ret
...
.L2416:
	ld	a0,0(a5)
	beq	a1,a0,.L2416
	 1: lr.d a4,0(a5); bne a4,a0,1f; sc.d a3,a2,0(a5); bnez a3,1b; 1:
	bne	a0,a4,.L2416
	ret
...
.L2426:
	...
	sext.w	a5,a5
	bne	a1,a5,.L2426
	fence iorw,ow;  1: lr.w.aq a5,0(a0); bne a5,a1,1f; sc.w.aq a3,a4,0(a0); bnez a3,1b; 1:
	sext.w	a5,a5
	bne	a5,a1,.L2426
	mv	a0,a1
	ret
...
.L2431:
	...
	sext.w	a5,a5
	bne	a1,a5,.L2431
	 1: lr.w.aq a5,0(a0); bne a5,a1,1f; sc.w.aq a3,a4,0(a0); bnez a3,1b; 1:
	sext.w	a5,a5
	bne	a5,a1,.L2431
	mv	a0,a1
	ret
...
.L2436:
	...
	sext.w	a5,a5
	bne	a1,a5,.L2436
	 1: lr.w a5,0(a0); bne a5,a1,1f; sc.w a3,a4,0(a0); bnez a3,1b; 1:
	sext.w	a5,a5
	bne	a5,a1,.L2436
	mv	a0,a1
	ret
...
.L2466:
	...
	sext.w	a5,a5
	bne	a0,a5,.L2466
	fence iorw,ow;  1: lr.w.aq a5,0(a4); bne a5,a0,1f; sc.w.aq a3,a2,0(a4); bnez a3,1b; 1:
	sext.w	a5,a5
	bne	a5,a0,.L2466
	ret
...
.L2471:
	...
	sext.w	a5,a5
	bne	a0,a5,.L2471
	 1: lr.w.aq a5,0(a4); bne a5,a0,1f; sc.w.aq a3,a2,0(a4); bnez a3,1b; 1:
	sext.w	a5,a5
	bne	a5,a0,.L2471
	ret
...
.L2476:
	...
	sext.w	a5,a5
	bne	a0,a5,.L2476
	 1: lr.w a5,0(a4); bne a5,a0,1f; sc.w a3,a2,0(a4); bnez a3,1b; 1:
	sext.w	a5,a5
	bne	a5,a0,.L2476
	ret
...
.L2486:
	...
	fence	iorw,iorw
	bne	a1,a5,.L2486
	fence iorw,ow;  1: lr.d.aq a5,0(a0); bne a5,a1,1f; sc.d.aq a3,a4,0(a0); bnez a3,1b; 1:
	bne	a1,a5,.L2486
	mv	a0,a1
	ret
...
.L2491:
	ld	a5,0(a0)
	bne	a1,a5,.L2491
	 1: lr.d.aq a5,0(a0); bne a5,a1,1f; sc.d.aq a3,a4,0(a0); bnez a3,1b; 1:
	bne	a1,a5,.L2491
	mv	a0,a1
	ret
...
.L2496:
	ld	a5,0(a0)
	bne	a1,a5,.L2496
	 1: lr.d a5,0(a0); bne a5,a1,1f; sc.d a3,a4,0(a0); bnez a3,1b; 1:
	bne	a1,a5,.L2496
	mv	a0,a1
	ret
...
.L2526:
	...
	fence	iorw,iorw
	bne	a0,a5,.L2526
	fence iorw,ow;  1: lr.d.aq a5,0(a4); bne a5,a0,1f; sc.d.aq a3,a2,0(a4); bnez a3,1b; 1:
	bne	a0,a5,.L2526
	ret
...
.L2531:
	ld	a5,0(a4)
	bne	a0,a5,.L2531
	 1: lr.d.aq a5,0(a4); bne a5,a0,1f; sc.d.aq a3,a2,0(a4); bnez a3,1b; 1:
	bne	a0,a5,.L2531
	ret
...
.L2536:
	ld	a5,0(a4)
	bne	a0,a5,.L2536
	 1: lr.d a5,0(a4); bne a5,a0,1f; sc.d a3,a2,0(a4); bnez a3,1b; 1:
	bne	a0,a5,.L2536
	ret
